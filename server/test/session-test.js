...
describe('35 . PATCH mentor can accept session', () => {
  beforeEach((done) => {
...
describe('36 . PATCH mentor can accept session ehen session is already accepted', () => {
  beforeEach((done) => {
    chai.request(app).post('/api/v1/auth/signin').send({ email: 'chance@gmail.com', password: 'iradukunda' }).then((res) => {
      mentorToken = res.body.data.token;
      // console.log(res.body.data.token);
...
describe('37 . PATCH mentor can accept session ehen session is not found', () => {
  beforeEach((done) => {
    chai.request(app).post('/api/v1/auth/signin').send({ email: 'chance@gmail.com', password: 'iradukunda' }).then((res) => {
      mentorToken = res.body.data.token;
      // console.log(res.body.data.token);
...
describe('38 . PATCH mentor can accept session ehen session is not integer', () => {
  beforeEach((done) => {
    chai.request(app).post('/api/v1/auth/signin').send({ email: 'chance@gmail.com', password: 'iradukunda' }).then((res) => {
      mentorToken = res.body.data.token;
      // console.log(res.body.data.token);
